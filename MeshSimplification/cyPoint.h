...
public:
	...
	cyPoint3f& operator*=(float n) { x*=n; y*=n; z*=n; return *this; }
	cyPoint3f& operator/=(float n) { x/=n; y/=n; z/=n; return *this; }
	cyPoint3f& operator=( const cyPoint3f &pt) { x=pt.x; y = pt.y; z = pt.z; return *this; }	// by swhsu
	...
	void dump() {cerr << "x: " << x << " y: " << y << " z: " << z << " , len: " << Length() << endl; }	// by swhsu
};
...
public:
	...
	cyPoint4f( const cyPoint3f &pt, float _w ) { x=pt.x; y=pt.y; z=pt.z; w=1.0f; }
